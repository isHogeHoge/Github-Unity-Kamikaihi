...
public class RIGHT : IDirection
{
    ...
    {
        animator.Play("PlayerStop_RIGHT");
    }
    // Player移動アニメーション再生(右)
    ...
    // Playerキックアニメーション再生(右)
    public void PlayKickAnima(Animator animator)
    {
        animator.Play("PlayerKick_RIGHT");
    }
    ...
    public bool ObstacleExistsToDistination(GameObject col_slime)
    {
        ...
        // キックしたスライムの右隣にオブジェクトがないか調べる(rayを+右1マス先へ発射)
